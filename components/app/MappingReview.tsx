...
import { X, Check, Edit, Plus, AlertCircle, ChevronDown, ChevronRight, ArrowRight } from '@/components/icons';
...
export function MappingReview({ projectId }: MappingReviewProps) {
